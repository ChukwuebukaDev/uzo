...
import { Marker } from "../map/leaflet/leaflet";
...
export default function MapContainer({ children, properties }: MapWrapperProps) {
  const { zoom, center, zoomControl, scrollWheelZoom, searchControl } = properties;
